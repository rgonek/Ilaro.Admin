...
namespace Ilaro.Admin.ViewModels
{
    ...
    public class Property
    {
        ...
        private readonly IList<Type> _realNumbersTypes = new List<Type>
        {
        ...
        private readonly IList<Type> _floatingPointNumbersTypes = new List<Type>
        {
        ...
        public string StringValue
        {
            get
            {
                ...
                if (
                    ...
                    _floatingPointNumbersTypes.Contains(PropertyType))
                {
                    try
                    {
                        return Convert
        ...
        public Property(Entity entity, PropertyInfo property)
        {
            ...
            ValidationAttributes =
                Attributes.OfType<ValidationAttribute>().ToList();
        ...
        private void DeterminePropertyInfo()
        {
            ...
            IsCollection =
                PropertyType.GetInterface("IEnumerable`1") != null &&
        ...
        private void SetDataType(object[] attributes)
        {
            ...
            else if (PropertyType.IsEnum)
            {
                ...
                _realNumbersTypes.Contains(PropertyType) ||
                _floatingPointNumbersTypes.Contains(PropertyType))
            {
                DataType = DataType.Numeric;
                if (_floatingPointNumbersTypes.Contains(PropertyType))
                {
            ...
            {
                ImageOptions.Settings = new[]
                {
                    new ImageSettings("Content/" + Entity.Name)
                };
            }
        }

        private static DataType ConvertDataType(
            System.ComponentModel.DataAnnotations.DataType sourceDataType)
        {
        ...
        public void SetTemplatesName()
        {
            ...
            else
            {
                if (IsForeignKey)
                {
                    EditorTemplateName = IsCollection ?
                ...
                if (!DisplayTemplateName.IsNullOrEmpty()) return;
        ...
        public MultiSelectList GetPossibleValues(bool addChooseItem = true)
        {
            if (IsForeignKey)
            {
                ...
                return IsCollection ?
                    new MultiSelectList(options, "Key", "Value", Values) :
                    new SelectList(options, "Key", "Value", Value);
            }
            else
            {
                var options = addChooseItem ?
                    EnumType.GetOptions(String.Empty, IlaroAdminResources.Choose) :
                    EnumType.GetOptions();
