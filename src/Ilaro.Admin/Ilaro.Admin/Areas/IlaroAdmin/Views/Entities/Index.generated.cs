...
namespace ASP
{
    ...
    [PageVirtualPath("~/Areas/IlaroAdmin/Views/Entities/Index.cshtml")]
    public partial class _Areas_IlaroAdmin_Views_Entities_Index_cshtml : WebViewPage<EntitiesIndexModel>
    {
...
, Tuple.Create(Tuple.Create("", 1959), Tuple.Create<Object, Int32>(Url.Action("Create", "Entity", new { area = "IlaroAdmin", entityName = Model.Entity.Name })
...
, Tuple.Create(Tuple.Create("", 3174), Tuple.Create<Object, Int32>(column.SortDirection
...
, Tuple.Create(Tuple.Create("", 3362), Tuple.Create<Object, Int32>(Model.Entity.Links.Count
...
, Tuple.Create(Tuple.Create("", 3943), Tuple.Create<Object, Int32>(string.Format(Model.Entity.Links.Display, row.LinkKeyValue)
...
, Tuple.Create(Tuple.Create("", 4410), Tuple.Create<Object, Int32>(string.Format(Model.Entity.Links.Edit, row.LinkKeyValue)
...
, Tuple.Create(Tuple.Create("", 4696), Tuple.Create<Object, Int32>(Url.Action("Edit", "Entity", new { area = "IlaroAdmin", entityName = Model.Entity.Name, key = row.KeyValue })
...
, Tuple.Create(Tuple.Create("", 5240), Tuple.Create<Object, Int32>(string.Format(Model.Entity.Links.Delete, row.LinkKeyValue)
...
, Tuple.Create(Tuple.Create("", 5559), Tuple.Create<Object, Int32>(Url.Action("Delete", "Entity", new { area = "IlaroAdmin", entityName = Model.Entity.Name, key = row.KeyValue })
...
, Tuple.Create(Tuple.Create("", 6742), Tuple.Create<Object, Int32>(Model.Configuration.PerPageRequestName
...
, Tuple.Create(Tuple.Create("", 7725), Tuple.Create<Object, Int32>(Url.Action("Index", "Entities", new { area = "IlaroAdmin", entityName = Model.Entity.Name, page = Model.Pager.Current })
