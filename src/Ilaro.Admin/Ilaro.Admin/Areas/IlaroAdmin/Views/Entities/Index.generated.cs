...
WriteAttribute("href", Tuple.Create(" href=\"", 3936), Tuple.Create("\"", 4009)
            
            #line 86 "..\..\Areas\IlaroAdmin\Views\Entities\Index.cshtml"
, Tuple.Create(Tuple.Create("", 3943), Tuple.Create<Object, Int32>(string.Format(Model.Entity.Links.Display, row.JoinedLinkKeyValue)
...
WriteAttribute("href", Tuple.Create(" href=\"", 4409), Tuple.Create("\"", 4479)
            
            #line 94 "..\..\Areas\IlaroAdmin\Views\Entities\Index.cshtml"
, Tuple.Create(Tuple.Create("", 4416), Tuple.Create<Object, Int32>(string.Format(Model.Entity.Links.Edit, row.JoinedLinkKeyValue)
...
WriteAttribute("href", Tuple.Create(" href=\"", 4701), Tuple.Create("\"", 4824)
            
            #line 98 "..\..\Areas\IlaroAdmin\Views\Entities\Index.cshtml"
, Tuple.Create(Tuple.Create("", 4708), Tuple.Create<Object, Int32>(Url.Action("Edit", "Entity", new { area = "IlaroAdmin", entityName = Model.Entity.Name, key = row.JoinedKeyValue })
...
WriteAttribute("href", Tuple.Create(" href=\"", 5251), Tuple.Create("\"", 5323)
            
            #line 107 "..\..\Areas\IlaroAdmin\Views\Entities\Index.cshtml"
, Tuple.Create(Tuple.Create("", 5258), Tuple.Create<Object, Int32>(string.Format(Model.Entity.Links.Delete, row.JoinedLinkKeyValue)
...
WriteAttribute("href", Tuple.Create(" href=\"", 5561), Tuple.Create("\"", 5686)
            
            #line 111 "..\..\Areas\IlaroAdmin\Views\Entities\Index.cshtml"
, Tuple.Create(Tuple.Create("", 5568), Tuple.Create<Object, Int32>(Url.Action("Delete", "Entity", new { area = "IlaroAdmin", entityName = Model.Entity.Name, key = row.JoinedKeyValue })
...
WriteAttribute("for", Tuple.Create(" for=\"", 6751), Tuple.Create("\"", 6796)
            
            #line 133 "..\..\Areas\IlaroAdmin\Views\Entities\Index.cshtml"
, Tuple.Create(Tuple.Create("", 6757), Tuple.Create<Object, Int32>(Model.Configuration.PerPageRequestName
...
WriteAttribute("href", Tuple.Create(" href=\"", 7733), Tuple.Create("\"", 7861)
            
            #line 156 "..\..\Areas\IlaroAdmin\Views\Entities\Index.cshtml"
, Tuple.Create(Tuple.Create("", 7740), Tuple.Create<Object, Int32>(Url.Action("Index", "Entities", new { area = "IlaroAdmin", entityName = Model.Entity.Name, page = Model.Pager.Current })
