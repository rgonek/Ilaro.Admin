...
namespace ASP
{
    ...
    public partial class _Areas_IlaroAdmin_Views_Entity_Create_cshtml : WebViewPage<EntityCreateModel>
    {
...
WriteAttribute("class", Tuple.Create(" class=\"", 1403), Tuple.Create("\"", 1514)
            ...
            #line 36 "..\..\Areas\IlaroAdmin\Views\Entity\Create.cshtml"
                , Tuple.Create(Tuple.Create("", 1411), Tuple.Create<Object, Int32>(Html.Condition(group.IsCollapsed, () => "glyphicon glyphicon-plus", () => "glyphicon glyphicon-minus")
...
, Tuple.Create(Tuple.Create(" ", 1574), Tuple.Create<Object, Int32>(Html.Condition(group.IsCollapsed, () => "hide")
...
, Tuple.Create(Tuple.Create("", 1980), Tuple.Create<Object, Int32>(Url.Action("Create", new { entityName = property.ForeignEntity.Name })
...
, Tuple.Create(Tuple.Create("", 2657), Tuple.Create<Object, Int32>(Url.Action("Create", new { entityName = property.ForeignEntity.Name })
...
, Tuple.Create(Tuple.Create("", 3464), Tuple.Create<Object, Int32>(Url.Action("Index", "Entities", new { area = "IlaroAdmin", entityName = Model.Entity.Name }, null)
