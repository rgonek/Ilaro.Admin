...
namespace ASP
{
    ...
    [PageVirtualPath("~/Areas/IlaroAdmin/Views/Entity/Delete.cshtml")]
    public partial class _Areas_IlaroAdmin_Views_Entity_Delete_cshtml : WebViewPage<EntityDeleteModel>
    {
...
WriteAttribute("for", Tuple.Create(" for=\"", 1397), Tuple.Create("\"", 1466)
            
            #line 35 "..\..\Areas\IlaroAdmin\Views\Entity\Delete.cshtml"
, Tuple.Create(Tuple.Create("", 1403), Tuple.Create<Object, Int32>(Html.IdFor(m => Model.PropertiesDeleteOptions[i].DeleteOption)
...
WriteAttribute("href", Tuple.Create(" href=\"", 2304), Tuple.Create("\"", 2330)
            
            #line 51 "..\..\Areas\IlaroAdmin\Views\Entity\Delete.cshtml"
, Tuple.Create(Tuple.Create("", 2311), Tuple.Create<Object, Int32>(Url.Action("Edit")
...
WriteAttribute("href", Tuple.Create(" href=\"", 2442), Tuple.Create("\"", 2516)
            
            #line 52 "..\..\Areas\IlaroAdmin\Views\Entity\Delete.cshtml"
, Tuple.Create(Tuple.Create("", 2449), Tuple.Create<Object, Int32>(Url.Action("Index", "Entities", new { area = "IlaroAdmin" }, null)
