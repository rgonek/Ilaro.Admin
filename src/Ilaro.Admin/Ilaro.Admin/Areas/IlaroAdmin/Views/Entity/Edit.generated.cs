...
WriteAttribute("class", Tuple.Create(" class=\"", 1251), Tuple.Create("\"", 1362)
            ...
            #line 30 "..\..\Areas\IlaroAdmin\Views\Entity\Edit.cshtml"
                , Tuple.Create(Tuple.Create("", 1259), Tuple.Create<System.Object, System.Int32>(Html.Condition(group.IsCollapsed, () => "glyphicon glyphicon-plus", () => "glyphicon glyphicon-minus")
...
, Tuple.Create(Tuple.Create(" ", 1422), Tuple.Create<System.Object, System.Int32>(Html.Condition(group.IsCollapsed, () => "hide")
...
, Tuple.Create(Tuple.Create("", 1828), Tuple.Create<System.Object, System.Int32>(Url.Action("Create", new { entityName = property.ForeignEntity.Name })
...
, Tuple.Create(Tuple.Create("", 2505), Tuple.Create<System.Object, System.Int32>(Url.Action("Create", new { entityName = property.ForeignEntity.Name })
...
, Tuple.Create(Tuple.Create("", 3312), Tuple.Create<System.Object, System.Int32>(Url.Action("Index", "Entities", new { area = "IlaroAdmin", entityName = Model.Entity.Name })
