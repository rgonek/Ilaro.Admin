...
namespace ASP
{
    ...
    public partial class _Areas_IlaroAdmin_Views_Entity_Edit_cshtml : WebViewPage<EntityCreateOrEditModel>
    {
...
WriteAttribute("class", Tuple.Create(" class=\"", 1553), Tuple.Create("\"", 1664)
            ...
            #line 41 "..\..\Areas\IlaroAdmin\Views\Entity\Edit.cshtml"
                , Tuple.Create(Tuple.Create("", 1561), Tuple.Create<Object, Int32>(Html.Condition(group.IsCollapsed, () => "glyphicon glyphicon-plus", () => "glyphicon glyphicon-minus")
...
, Tuple.Create(Tuple.Create(" ", 1724), Tuple.Create<Object, Int32>(Html.Condition(group.IsCollapsed, () => "hide")
...
, Tuple.Create(Tuple.Create("", 2159), Tuple.Create<Object, Int32>(Url.Action("Create", new { entityName = property.ForeignEntity.Name })
...
, Tuple.Create(Tuple.Create("", 2865), Tuple.Create<Object, Int32>(Url.Action("Create", new { entityName = property.ForeignEntity.Name })
...
, Tuple.Create(Tuple.Create("", 3672), Tuple.Create<Object, Int32>(Url.Action("Index", "Entities", new { area = "IlaroAdmin", entityName = Model.Entity.Name })
...
, Tuple.Create(Tuple.Create("", 3842), Tuple.Create<Object, Int32>(Url.Action("Delete", new { entityName = Model.Entity.Name, key = Model.Entity.JoinedKeyValue })
