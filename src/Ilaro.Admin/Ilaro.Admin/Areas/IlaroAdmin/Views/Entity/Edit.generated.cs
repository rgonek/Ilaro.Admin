...
namespace ASP
{
    ...
    [PageVirtualPath("~/Areas/IlaroAdmin/Views/Entity/Edit.cshtml")]
    public partial class _Areas_IlaroAdmin_Views_Entity_Edit_cshtml : WebViewPage<EntityEditModel>
    {
...
WriteAttribute("class", Tuple.Create(" class=\"", 1251), Tuple.Create("\"", 1362)
            
            #line 30 "..\..\Areas\IlaroAdmin\Views\Entity\Edit.cshtml"
                , Tuple.Create(Tuple.Create("", 1259), Tuple.Create<Object, Int32>(Html.Condition(group.IsCollapsed, () => "glyphicon glyphicon-plus", () => "glyphicon glyphicon-minus")
...
WriteAttribute("class", Tuple.Create(" class=\"", 1408), Tuple.Create("\"", 1471)
, Tuple.Create(Tuple.Create("", 1416), Tuple.Create("fields", 1416), true)
            
            #line 31 "..\..\Areas\IlaroAdmin\Views\Entity\Edit.cshtml"
, Tuple.Create(Tuple.Create(" ", 1422), Tuple.Create<Object, Int32>(Html.Condition(group.IsCollapsed, () => "hide")
...
WriteAttribute("href", Tuple.Create(" href=\"", 1821), Tuple.Create("\"", 1899)
            
            #line 38 "..\..\Areas\IlaroAdmin\Views\Entity\Edit.cshtml"
, Tuple.Create(Tuple.Create("", 1828), Tuple.Create<Object, Int32>(Url.Action("Create", new { entityName = property.ForeignEntity.Name })
...
WriteAttribute("href", Tuple.Create(" href=\"", 2498), Tuple.Create("\"", 2576)
            
            #line 54 "..\..\Areas\IlaroAdmin\Views\Entity\Edit.cshtml"
, Tuple.Create(Tuple.Create("", 2505), Tuple.Create<Object, Int32>(Url.Action("Create", new { entityName = property.ForeignEntity.Name })
...
WriteAttribute("href", Tuple.Create(" href=\"", 3305), Tuple.Create("\"", 3405)
            
            #line 67 "..\..\Areas\IlaroAdmin\Views\Entity\Edit.cshtml"
, Tuple.Create(Tuple.Create("", 3312), Tuple.Create<Object, Int32>(Url.Action("Index", "Entities", new { area = "IlaroAdmin", entityName = Model.Entity.Name })
...
, Tuple.Create(Tuple.Create("", 3482), Tuple.Create<Object, Int32>(Url.Action("Delete", new { entityName = Model.Entity.Name, key = Model.Entity.Key.Value.AsString })
