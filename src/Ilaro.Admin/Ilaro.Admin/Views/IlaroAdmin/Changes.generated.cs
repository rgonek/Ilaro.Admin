...
namespace Ilaro.Admin.Views.IlaroAdmin
{
    ...
    [PageVirtualPath("~/Views/IlaroAdmin/Changes.cshtml")]
    public partial class Changes : WebViewPage<ChangesViewModel>
    {
        public Changes()
        {
        }
...
, Tuple.Create(Tuple.Create("", 2559), Tuple.Create<Object, Int32>(column.SortDirection
...
, Tuple.Create(Tuple.Create("", 4582), Tuple.Create<Object, Int32>(Url.Action("Changes", new { entityName = Model.Entity.Name, page = Model.PagerInfo.Current })
