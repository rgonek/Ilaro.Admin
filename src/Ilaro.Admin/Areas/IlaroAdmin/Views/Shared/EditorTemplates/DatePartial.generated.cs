...
WriteLiteral("        ");
   ...
   Write(Html.TextBox(Model.Property.Name, Model.AsObject.ToShortDateString(Model.Property), Model.Property, new { @class = "form-control", data_date_format = Model.Property.GetDateFormat() }));
